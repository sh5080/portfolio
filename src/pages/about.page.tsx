    ...
    <AboutContainer className={"fade-in"}>
      ...
      <Description>
        <p>
          ...
          개발자 김승환입니다. 저를 3가지 키워드로 나타내고자 합니다.
        </p>
        <p style={{ fontWeight: "bold", fontSize: "1.2rem" }}>
          첫째는 가치관 입니다.
        </p>
        <p>
          포지션이나 언어가 중요한게 아니라 어떻게 문제를 해결하는 것이
          중요하다고 생각합니다. 해결하기 위해서 무엇을 배워야 하는지 찾아서
          배우고, 그 것들을 적용하는 것이 중요하다고 생각합니다. 그래서 저는
          풀스택 개발자는 단순히 프론트 / 백이 아니라 모든 포지션에 있어 두루
          두루 다 자신 있는 개발자라고 생각합니다.
        </p>
        <p>
        ...
        <p>
          ...
          백오피스를 통해 pm에서 처리하도록 구현했고, pm 요구사항에 맞추어 추가
          개발, 유지보수를 진행하고 있습니다.
        </p>
      </Description>
    </AboutContainer>
