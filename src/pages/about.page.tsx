    ...
    <AboutContainer className={"fade-in"}>
      ...
      <Description>
        <p>
          ...
          개발자 김승환입니다. 무엇보다 코딩이 재밌어서 가능한 선 안에서
          동료들의 어려움을 퇴근하고 찾아보며 도움을 주고 있으며, 직무라고
          여기기보다는 재밌게 즐기고 있습니다.
        </p>
        <p>저의 가장 큰 장점은 첫째는 끈기와 마인드입니다.</p>
        ...
        <p>
          때에 따라서는 외면하지 않고 지나치지 않을 때가 있습니다. 처음 입사한
          회사에서는 비효율적 (DB 쿼리) / 보안적 (SQL인젝션, http api 요청 등)
          불안한 로직들이 있었고, 이사님은 당장 그 부분보다는 개발 진척을
          원하셨고, 솔직히 설득이 어려웠습니다. 할당량 작업 이후 퇴근 후에 앞서
          언급한 내용들을 매일 작업했습니다.
        </p>
        <p>
          로직들 개선 이후 유의미한 성과가 있었습니다. 솔직히 당연한 것을 했을
          뿐이라고 생각하고 있고, 엄청난 것들을 진행한 것은 아니지만 리팩토링한
          결과 특정 로직에서 약 20%가량 응답시간 개선이 있었고, 적극적으로 일을
          찾아서 하는 모습들을 좋게 봐주셔서 회사에서 팀장으로 일하기도 했고, 그
          경험들 덕분에 현재 회사에서 lg앱 서버 운영 / 유지보수 관련한 개발을
          하고 있습니다.
        </p>
      </Description>
    </AboutContainer>
